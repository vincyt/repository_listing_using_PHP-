    ...
    var L = function(h) {
        var j = function(e) {
            ...
            function ja(a, b) {
                var c = a.fnFormatNumber(a._iDisplayStart + 1),
                    ...
                    g = a._iDisplayStart === -1 ? 0 : Math.ceil( a._iDisplayStart / a._iDisplayLength ) + 1,
                    h = a._iDisplayLength === -1 ? 0 : Math.ceil( a.fnRecordsDisplay() / a._iDisplayLength )
 
                 a.oScroll.bInfinite && (c = a.fnFormatNumber(1));
                return b.replace(/_START_/g, c).replace(/_END_/g, d).replace(/_TOTAL_/g, i).replace(/_MAX_/g, f).replace(/_PAGE_/g, g).replace(/_PAGES_/g, h)
            }
        ...
        j.defaults = {
            ...
            oLanguage: {
                ...
                sInfo: "Total results: _TOTAL_  |  Showing results: _START_ - _END_  |  Page :  _PAGE_ / _PAGES_",
